<?php
/**
 * Denna filen används för att kunna uppdatera handledar tabellen utan att behöva uppdatera webbsidan.
 * handledar data hämtas från databasen med hjälp av allHandledare funktionen i ViewFunctions.php
