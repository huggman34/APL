<?php
/**
 * Denna filen används för att kunna uppdatera plats tabellen utan att behöva uppdatera webbsidan.
 * plats data hämtas från databasen med hjälp av elevPlats funktionen i ViewFunctions.php
